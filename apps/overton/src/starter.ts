/**
 * The config `overton init` writes. Kept in the binary rather than read from
 * the repo so an installed copy works with no checkout.
 */

export const STARTER_CONFIG = `# ~/.overton/config.yaml
#
